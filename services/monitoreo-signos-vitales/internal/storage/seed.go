...
func Sembrar(repo SignosVitalesRepository) {
	...
	ejemplos := []models.EntradaSignosVitales{
		{IDAdultoMayor: "P001", RegistradoPor: "Cuidador Ana", PresionSistolica: 122, PresionDiastolica: 78, FrecuenciaCardiaca: 72, Temperatura: &temperaturaNormal, SaturacionOxigeno: &spo2Normal, NivelGlucosa: &glucosaNormal, NivelDolor: &dolorLeve, Observaciones: "Control de rutina."},
		{IDAdultoMayor: "P001", RegistradoPor: "Cuidador Ana", PresionSistolica: 145, PresionDiastolica: 92, FrecuenciaCardiaca: 98, Temperatura: &temperaturaNormal, SaturacionOxigeno: &spo2Normal, NivelGlucosa: &glucosaNormal, NivelDolor: &dolorLeve, Observaciones: "Revisar presión en próxima toma."},
		{IDAdultoMayor: "P002", RegistradoPor: "Cuidador Luis", PresionSistolica: 165, PresionDiastolica: 104, FrecuenciaCardiaca: 122, Temperatura: &temperaturaAlta, SaturacionOxigeno: &spo2Bajo, NivelGlucosa: &glucosaAlta, NivelDolor: &dolorAlto, Observaciones: "Se recomienda contactar al profesional de salud."},
	}
